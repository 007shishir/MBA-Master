 ...
 */
public class Entrepreneurship extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mTxt_topic_name.setText("Entrepreneurship and Small Business Management");
        ...
        mTxt_and_mem_p02.setText("E-Comm");
        mTxt_and_mem_p03.setText("DataMin");
        mTxt_and_mem_p04.setText("DBMS");
        ...
        switch (v.getId()) {
            case R.id.mTxt_and_mem_p01:
                ...
                Navigation.findNavController(v).
                        navigate(R.id.action_frag_entrepreneurship_to_memorise_recV, memorise_p01);
                break;
