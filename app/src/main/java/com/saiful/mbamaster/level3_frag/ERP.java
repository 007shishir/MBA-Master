...
public class ERP extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mTxt_topic_name.setText("Enterprise Resource Planning");
        ...
        mTxt_and_mem_p02.setText("Entrepreneur");
        mTxt_and_mem_p03.setText("E-Comm");
        mTxt_and_mem_p04.setText("DataMin");
        ...
        switch (v.getId()) {
            case R.id.mTxt_and_mem_p01:
                ...
                Navigation.findNavController(v).
                        navigate(R.id.action_frag_erp_to_memorise_recV, memorise_p01);
                break;
