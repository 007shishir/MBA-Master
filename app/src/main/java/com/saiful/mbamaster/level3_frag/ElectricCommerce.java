 ...
 */
public class ElectricCommerce extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mTxt_topic_name.setText("Electric Commerce");
        ...
        mTxt_and_mem_p02.setText("DataMin");
        mTxt_and_mem_p03.setText("DBMS");
        mTxt_and_mem_p04.setText("DSS");
        ...
        switch (v.getId()) {
            case R.id.mTxt_and_mem_p01:
                ...
                Navigation.findNavController(v).
                        navigate(R.id.action_frag_electric_commerce_to_memorise_recV, memorise_p01);
                break;
