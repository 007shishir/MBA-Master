 ...
 */
public class DBMS extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mTxt_topic_name.setText("Database Management System");
        ...
        mTxt_and_mem_p02.setText("DSS");
        mTxt_and_mem_p03.setText("ERP");
        mTxt_and_mem_p04.setText("Entrepreneur");
        ...
        switch (v.getId()) {
            case R.id.mTxt_and_mem_p01:
                ...
                Navigation.findNavController(v).
                        navigate(R.id.action_frag_dbms_to_memorise_recV, memorise_p01);
                break;
