 ...
 */
public class Principle_of_Management extends Fragment implements View.OnClickListener {
    ...
    public Principle_of_Management() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        sub_name = homeViewModel.getPrinManTopic().getValue();
