 ...
 */
public class Introduction_Business extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        sub_name = homeViewModel.getIBusTopic().getValue();
