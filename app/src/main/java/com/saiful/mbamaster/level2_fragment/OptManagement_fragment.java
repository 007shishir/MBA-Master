 ...
 */
public class OptManagement_fragment extends Fragment implements View.OnClickListener {
    ...
    View rootView;
    Level2_ViewModel level2_viewModel;    TextView mTxt_topic_name;
    String child_name, sub_name;

    public OptManagement_fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        sub_name = level2_viewModel.getOptManagement_subject().getValue();
        ...
        mTxt_and_mem_p02.setText("SupplyChain");
        mTxt_and_mem_p03.setText("Economics");
        mTxt_and_mem_p04.setText("Statics");
        ...
        switch (v.getId()) {
            case R.id.mTxt_and_mem_p01:
                ...
                Navigation.findNavController(v).
                        navigate(R.id.action_operation_management_to_memorise_recV, memorise_p01);
                break;
            case R.id.mTxt_and_mem_p02:
                child_name = level2_viewModel.getSupplyChain_child().getValue();
    ...
    public void navigateNEXT_fragment(){
        Bundle memorise = new Bundle();
        memorise.putString("child_name", child_name);
        Navigation.findNavController(Objects.requireNonNull(getView())).
                navigate(R.id.action_operation_management_to_memorise_recV, memorise);
    }
