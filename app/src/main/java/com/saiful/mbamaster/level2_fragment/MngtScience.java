 ...
 */
public class MngtScience extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        sub_name = level2_viewModel.getMngtScience_subject().getValue();
        ...
        mTxt_and_mem_p02.setText("OptMngt");
        mTxt_and_mem_p03.setText("SupplyChain");
        mTxt_and_mem_p04.setText("Economics");
        ...
        switch (v.getId()) {
            case R.id.mTxt_and_mem_p01:
                ...
                Navigation.findNavController(v).
                        navigate(R.id.action_mngt_science_to_memorise_recV, memorise_p01);
                break;
