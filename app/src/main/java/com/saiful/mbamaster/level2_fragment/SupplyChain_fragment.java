 ...
 */
public class SupplyChain_fragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        sub_name = level2_viewModel.getSupplyChain_subject().getValue();
        ...
        mTxt_and_mem_p03.setText("Statics");
        mTxt_and_mem_p04.setText("MngtScience");
        ...
        switch (v.getId()) {
            case R.id.mTxt_and_mem_p01:
                ...
                Navigation.findNavController(v).
                        navigate(R.id.action_supply_chain_to_memorise_recV, memorise_p01);
                break;
